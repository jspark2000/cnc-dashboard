...
import FileUploadComponent from './data/FileUploadSection'
    ...
    <Sidebar>
      <SidebarContent>
        <div className="flex w-full flex-col space-y-5 px-4 py-5">
          <img src="logo.png" className="my-5 h-14 w-auto object-contain" />
          ...
          <div className="grid w-full max-w-sm items-center gap-1.5">
            ...
            <Select
              value={selectedFile}
              onValueChange={(e: any) => updateSelectedFile(e)}
            >
              <SelectTrigger>
                <SelectValue
                  placeholder={
